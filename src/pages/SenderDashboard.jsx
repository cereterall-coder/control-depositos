...
import {
    ...
    Upload, DollarSign, Calendar, Eye, Activity, UserPlus, Star, Trash2, X, Camera, Ban, Link as LinkIcon, RefreshCw, LogOut, User, Users, FilePieChart, Mail, Search, ArrowRight, ArrowLeft, Lock
} from 'lucide-react';
                                            ...
                                            <div style={{ display: 'flex', gap: '0.5rem' }}>
                                                ...
                                                {reportType === 'trash' ? (
                                                    <>
                                                        ...
                                                        <button onClick={() => handleDeletePermanent(dep.id)} className="btn-icon" style={{ color: 'var(--color-danger)', background: 'rgba(239,68,68,0.1)' }} title="Eliminar Definitivamente">
                                                            <Trash2 size={16} />
                                                        </button>
                                                    </>
                                                ) : (
